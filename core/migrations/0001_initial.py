# Generated by Django 6.0.1 on 2026-03-23 07:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('health', 'Health'), ('education', 'Education'), ('employment', 'Employment'), ('welfare', 'Welfare'), ('agriculture', 'Agriculture')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.CharField(blank=True, choices=[('none', 'No Formal Education'), ('primary', 'Primary School'), ('secondary', 'Secondary School'), ('graduate', 'Graduate'), ('postgrad', 'Post Graduate')], max_length=20)),
